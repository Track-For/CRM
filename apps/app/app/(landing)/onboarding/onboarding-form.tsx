	...
	return (
		...
		>
			<FieldGroup>
				...
				<Field>
					<FieldLabel htmlFor={slugId}>URL do workspace</FieldLabel>
					<InputGroup>
						<InputGroupAddon>
					...
					<FieldDescription>
						Sua equipe vai usar este endereço para abrir o CRM.
					</FieldDescription>
				</Field>
				...
				<Field>
					...
					<FieldDescription>
						Lido uma vez, para que toda resposta depois saiba o que você vende.
					</FieldDescription>
				</Field>
			</FieldGroup>
