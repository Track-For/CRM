...
export const metadata: Metadata = {
	...
	description:
		"A primeira experiência de CRM agêntico — agentes de pesquisa duráveis que leem sua caixa de entrada, mantêm todo registro atualizado e agendam seus próprios follow-ups.",
};
