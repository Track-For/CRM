		...
		<Sheet open={open} onOpenChange={(next) => setOpen(next || null)}>
			...
			<SheetContent side="right">
				<SheetHeader>
					...
					<SheetDescription>
						Dê um nome e um domínio. O agente preenche o logo, a descrição, o
						setor, o endereço e as redes sociais.
					</SheetDescription>
				</SheetHeader>
				...
				>
					<FieldGroup>
						...
						<Field>
							...
							/>
							<FieldDescription>
								Uma URL completa também funciona — ela é reduzida ao domínio
								puro, que precisa ser único.
							</FieldDescription>
						</Field>
