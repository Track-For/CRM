			...
			>
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							Os agentes param de enviar para o Slack imediatamente, e a lista
							de canais em cache é limpa para que um novo app a releia. Quem
							corresponde a qual conta do Slack é mantido, então reconectar o
							mesmo workspace não pede para você corresponder todo mundo de
							novo.
						</AlertDialogDescription>
					</AlertDialogHeader>
					<AlertDialogFooter>
