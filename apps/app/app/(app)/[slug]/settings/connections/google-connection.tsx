...
const SOURCES = {
	calendar: {
		label: "Reuniões",
		autoCreate:
			"Adicionar a empresa e o contato quando você conhecer alguém novo",
	},
	gmail: {
		label: "E-mail",
		autoCreate:
			"Adicionar a empresa e o contato quando você responder a alguém novo",
	},
} as const;
	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					Defina GOOGLE_CLIENT_ID e GOOGLE_CLIENT_SECRET no arquivo .env raiz e
					reinicie.
				</CardDescription>
			</CardHeader>
		</Card>
...
const CONNECT_ERRORS = new Map([
	[
		"email_doesn't_match",
		"Essa conta do Google tem um endereço de e-mail diferente do que você usa para entrar, então ela não pode ser vinculada à sua conta. Conecte a conta do Google que corresponde ao seu endereço de login.",
	],
]);
	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					Gmail e Agenda somente leitura. Apenas conversas com empresas do CRM
					são armazenadas.
				</CardDescription>
					...
					<Alert variant="destructive">
						...
						<AlertDescription>
							{CONNECT_ERRORS.get(connectError) ??
								"O Google retornou um erro antes de concluir a conexão. Tente de novo."}
						</AlertDescription>
					</Alert>
				</CardContent>
			) : null}
	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					Reuniões e conversas por e-mail chegam à empresa correspondente assim
					que acontecem.
				</CardDescription>
			...
			<CardContent>
				{!hasRefreshToken ? (
					<Alert variant="destructive" attention={insistence}>
						<Icon icon={Warning} />
						<AlertTitle>O Google não retornou um refresh token</AlertTitle>
					...
					<div className="-ml-2 flex flex-wrap items-center gap-1 text-muted-foreground">
						<AlertDialog>
							...
							<AlertDialogContent>
								<AlertDialogHeader>
									...
									<AlertDialogDescription>
										Todo e-mail e reunião trazidos do Google são removidos do
										CRM. A próxima verificação começa a partir de agora, então
										nada excluído aqui volta.
									</AlertDialogDescription>
								</AlertDialogHeader>
								...
								<AlertDialogHeader>
									...
									<AlertDialogDescription>
										{required
											...
											: "Novos e-mails e reuniões param de chegar. Tudo que já foi sincronizado permanece, e você pode conectar o Google de novo nesta página."}
									</AlertDialogDescription>
								</AlertDialogHeader>
						...
						<Button variant="ghost" size="xs" asChild>
							<Link
								...
								rel="noreferrer"
							>
								Gerenciar na sua conta do Google
							</Link>
						</Button>
					</div>
				</CardFooter>
