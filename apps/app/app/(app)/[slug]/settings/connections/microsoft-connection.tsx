...
const CONNECT_ERRORS = new Map([
	[
		"email_doesn't_match",
		"Essa conta da Microsoft tem um endereço de e-mail diferente do que você usa para entrar, então ela não pode ser vinculada à sua conta. Conecte a conta da Microsoft que corresponde ao seu endereço de login.",
	],
]);
	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					E-mail do Outlook somente leitura. Apenas conversas com empresas do
					CRM são armazenadas.
				</CardDescription>
					...
					<Alert variant="destructive">
						...
						<AlertDescription>
							{CONNECT_ERRORS.get(connectError) ??
								"A Microsoft retornou um erro antes de concluir a conexão. Tente de novo."}
						</AlertDescription>
					</Alert>
				</CardContent>
			) : null}
	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					Conversas por e-mail chegam à empresa correspondente assim que
					acontecem.
				</CardDescription>
			...
			<CardContent>
				{!hasRefreshToken ? (
					<Alert variant="destructive">
						<Icon icon={Warning} />
						<AlertTitle>A Microsoft não retornou um refresh token</AlertTitle>
							...
							<AlertDialogContent>
								<AlertDialogHeader>
									...
									<AlertDialogDescription>
										...
										verificação começa a partir de agora, então nada excluído
										aqui volta.
									</AlertDialogDescription>
								</AlertDialogHeader>
								...
								<AlertDialogHeader>
									...
									<AlertDialogDescription>
										{required
											...
											: "Novos e-mails param de chegar. Tudo que já foi sincronizado permanece, e você pode conectar a Microsoft de novo nesta página."}{" "}
										A Microsoft não tem como retirarmos o consentimento por aqui
										— remova este app da sua conta Microsoft para isso.
									</AlertDialogDescription>
								</AlertDialogHeader>
