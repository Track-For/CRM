...
const COLUMNS: SimpleTableColumn[] = [
	...
	{ id: "lastSeen", header: "Última visita", width: "w-28", align: "right" },
	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					O script registra visualizações de página só nesses hosts.
				</CardDescription>
			...
			{domains.length === 0 ? (
				<CardTableEmpty>
					Adicione o domínio em que seu site roda para obter seu script de
					rastreamento.
				</CardTableEmpty>
			) : (
