...
const TOGGLES = [
	{
		...
		hint: "Define o cookie no host exato que serviu a página, nunca no domínio pai",
	},
	{
		flag: "secureCookies",
		label: "Usar apenas cookies seguros",
		hint: "Envia o cookie por HTTPS e o descarta em HTTP simples",
	},
	{
		flag: "honourDnt",
		...
		<Card>
			...
			<CardContent>
				...
				<Field>
					...
					<FieldDescription>
						Depois disso, um visitante recorrente conta como alguém novo. Reduza
						se sua política exigir.
					</FieldDescription>
				</Field>
			</CardContent>
		</Card>
