...
const COLUMNS: SimpleTableColumn[] = [
	...
	{ id: "idle", header: "Inativo", width: "w-[8%]", align: "right" },
];
			...
			>
				{count === 0 ? (
					<SimpleTableRow>
						...
						>
							Nenhum negócio atendeu a esses filtros do funil.
						</TableCell>
					</SimpleTableRow>
				) : (
...
function tableTitle(result: DealListResult): string {
	...
	const stale = result.criteria.inactiveForDays === null ? "" : "parados ";
	return count === 0
...
function tableMeta(result: DealListResult): string {
	const details = [
		...
		result.criteria.inactiveForDays === null
			? null
			: `${result.criteria.inactiveForDays}+ dias inativos`,
