				...
				<DropdownMenu>
					<DropdownMenuTrigger asChild>
						...
						>
							...
							<span className="sr-only">Mais ações do chat</span>
						</Button>
					</DropdownMenuTrigger>
			...
			>
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							Isso exclui permanentemente o chat, suas mensagens, anexos e link
							compartilhado. Qualquer agente criado a partir dele continua
							disponível.
						</AlertDialogDescription>
					</AlertDialogHeader>
					<AlertDialogFooter>
