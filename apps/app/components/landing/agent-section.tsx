		...
		<section className="relative flex w-full shrink-0 flex-col items-center px-6 pt-20 md:pt-30">
			<div className="flex w-full max-w-6xl flex-col gap-12">
				<SectionHeading
					...
					lede="Descreva como seu CRM deve agir. Crie agentes para automatizar todo processo."
				/>
		...
		<div className="flex w-3xl max-w-full shrink-0 select-none flex-col pt-1">
			...
			<SuggestedAction className="gap-3">
				...
				<span className="min-w-0 grow">
					quando um contrato estiver há cinco dias sem assinatura
				</span>
			</SuggestedAction>
			...
			<SuggestedAction>
				...
				<Chip className="px-2">
					...
					reenriquecer contatos
				</Chip>
				<span className="shrink-0">que não são contatados há</span>
				<Chip className="px-2">
