	...
	if (compact) {
		return (
			<div className="grid shrink-0 grid-cols-2 border-border border-b bg-muted/40">
				<Stat label="Pipeline aberto" value="$0" className="border-r" />
				<Stat label="Negócios abertos" value="0" />
			</div>
		);
	}
			...
			<div className="flex max-w-xl flex-col items-center gap-2">
				...
				{compact ? null : (
					<p className="text-center text-muted-foreground text-xs/[19px]">
						Ele lê o site deles e nosso histórico com eles, e mostra o
						raciocínio.
					</p>
				)}
			</div>
