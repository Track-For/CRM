...
const SETUP_PROMPT =
	"Configure o trycompai/crm — instale as dependências, inicie o Postgres, crie meu .env e me diga quais chaves eu ainda preciso.";
	...
	return (
		...
		>
			...
			{copied
				...
				: "Copiar o prompt de configuração"}
			{copied ? (
				<Checkmark
