...
describe("chat date groups", () => {
	...
	test("uses deterministic UTC calendar buckets", () => {
		expect(chatDateGroup("2026-08-05T00:00:00.000Z", now)).toBe("Hoje");
		expect(chatDateGroup("2026-08-04T23:59:59.999Z", now)).toBe("Ontem");
		expect(chatDateGroup("2026-07-30T12:00:00.000Z", now)).toBe(
			"Últimos 7 dias",
		);
